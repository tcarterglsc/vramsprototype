...
const navigationConfig: FuseNavItemType[] = [
	{
		id: 'vrams',
		title: 'VRAMS',
		subtitle: 'Vehicle Request & Asset Management',
		type: 'group',
		...
		children: [
			...
			},
			{
				...
				type: 'item',
				icon: 'heroicons-outline:truck',
				url: '/apps/vrams/vehicles'
			},
			{
				id: 'vrams.maintenance',
				title: 'Maintenance',
				type: 'item',
				icon: 'heroicons-outline:wrench-screwdriver',
				url: '/apps/vrams/maintenance'
			},
			{
				id: 'vrams.dispatch',
				title: 'Dispatch',
